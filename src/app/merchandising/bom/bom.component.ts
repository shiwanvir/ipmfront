                ...
                for(var SOCount = 0; SOCount<this.selectedItemList.length; SOCount++){                   
                   ...
                   switch(orderType){
                    ...
                    case 3: // Retrieve order color & size
                        ...
                        const fullRatios = await this.http.get<any[]>(this.serverUrl + 'api/merchandising/bom/sizewise',{params:{'orderId':order_id}}).toPromise();
                          
                         for(let l=0;l<fullRatios.length;l++){ 

                            if((fullRatios[l]["size_name"]!='N/A')&& (fullRatios[l]["color_name"]!='N/A')){

                                 this.RatioQtys.push({"sizeratio":fullRatios[l]["size_name"],"sizeqty":fullRatios[l]["RatioQty"],"sizeid":fullRatios[l]["size_id"],"colorid":fullRatios[l]["color_id"],"colorname":fullRatios[l]["color_name"]});
